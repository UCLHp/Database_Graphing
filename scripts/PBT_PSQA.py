...
def pbt_psqa_graph(conn, Config):
    '''
    ...
    color_column = 'fluence measurements_gantry'
    custom_color_boolean = False
    custom_color_palette = []
    marker_column = 'point dose measurements_gantry'
    ...
    color_to_plot = ['Gantry 1', 'Gantry 2', 'Gantry 3', 'Gantry 4']
