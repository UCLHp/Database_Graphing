...
def pbt_isocentre_graph(conn, Config):
    ...
    AxisFields = ['adate', 'offset', 'x-offset', 'y-offset', 'diameter']
    ...
    layout_plots = column([button_row1, button_row2, select_gantry,
                           select_xaxis, select_yaxis, select_legend, p1, picker])
    ...
    def callback_range():
        ...
        if (plot1_xdata_to_plot == 'adate') and ((plot1_ydata_to_plot == 'offset')
            ...
            if plot1_ydata_to_plot == 'offset':
                p1.y_range.start = -0.5
                p1.y_range.end = 2.5
            elif plot1_ydata_to_plot == 'x-offset':
                p1.y_range.start = -2.5
                p1.y_range.end = 2.5
            elif plot1_ydata_to_plot == 'y-offset':
                p1.y_range.start = -2.5
                p1.y_range.end = 2.5
            elif plot1_ydata_to_plot == 'diameter':
                p1.y_range.start = 6
                p1.y_range.end = 16
