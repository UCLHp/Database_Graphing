...
from bokeh.models import (DatetimeTickFormatter, BasicTickFormatter, ColorPicker)
from bokeh.models.widgets import (CheckboxGroup, RangeSlider, Select,
                                  DateRangeSlider)
from bokeh.palettes import turbo, Colorblind, Category20, inferno, plasma, viridis
...
def Define_Plot_Parameters(p1, list):
    ...
    p1.background_fill_color = '#808080'
